...
public class Tester {
	...
	public static void testPart3() {
		...
		CardLock cardLockA = new CardLock();
		doorA.attachLock(cardLockA);
		SmartCard cardA = new SmartCard("studentSmartCard");
		cardLockA.swipeCard(cardA);
		doorA.openDoor();
		SmartCard cardB = new SmartCard("staffSmartCard");
		cardB.setStaff(true);
		cardLockA.swipeCard(cardB);
		doorA.openDoor();
	}
